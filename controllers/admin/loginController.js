...
const adminLogin=async(req,res)=>{
    ...
    if(errors.isEmpty())
    {
        var responseData=await loginService.adminLogin(req.body)
        const token=jwt.sign({_idInfo:responseData.data._id,emailInfo:responseData.data.email,},process.env.adminSecretKey,{expiresIn:"24h"})
