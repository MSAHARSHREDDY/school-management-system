const registrationRepository = require("../../repository/admin/registrationRepository");
...
const adminRegistration = async (body) => {
 ...
 const otpValue=otpGenerator.generate(6, { upperCaseAlphabets: false, specialChars: false,lowerCaseAlphabets:false });
  ...
  var responseData = await registrationRepository.adminRegistration(registration);
...
module.exports = { adminRegistration, find };
